...
import (
	...
	models "github.com/cristiandpt/DomesticApp_WebApp/data/model"
)
...
func NewMockDB(products []models.Product, customers []models.Customer, orders []models.Order) *MockDB {
	return &MockDB{
		products:  products,
		customers: customers,
		orders:    orders,
...
func NewMockDBLayerWithData() *MockDB {
	PRODUCTS := `[
	  {
		  "ID": 1,
  ...
  `
	...
	return NewMockDB(products, customers, orders)
}

func (mock *MockDB) GetMockProductData() []models.Product {
	return mock.products
}

func (mock *MockDB) GetMockCustomersData() []models.Customer {
	return mock.customers
}

func (mock *MockDB) GetMockOrdersDate() []models.Order {
	return mock.orders
}

func (mock *MockDB) SetError(err error) {
	mock.err = err
}

func (mock *MockDB) GetAllProducts() ([]models.Product, error) {
...
func (mock *MockDB) GetPromos() ([]models.Product, error) {
	if mock.err != nil {
		return nil, mock.err
	}
...
func (mock *MockDB) GetProduct(id int) (models.Product, error) {
	...
	return result, fmt.Errorf("No found the %d", id)
}

func (mock *MockDB) GetCustomerByName(first, last string) (models.Customer, error) {
...
func (mock *MockDB) AddUser(customer models.Customer) (models.Customer, error) {
	if mock.err != nil {
...
func (mock *MockDB) SignInUser(email, password string) (models.Customer, error) {
	if mock.err != nil {
		return models.Customer{}, mock.err
	}
	for _, customer := range mock.customers {
...
func (mock *MockDB) SignOutUserById(id int) error {
	if mock.err != nil {
		return mock.err
	}
	for _, customer := range mock.customers {
...
func (mock *MockDB) GetCustomerOrdersByID(id int) ([]models.Order, error) {
	if mock.err != nil {
		return nil, mock.err
	}
	for _, customer := range mock.customers {
...
func (mock *MockDB) AddOrder(order models.Order) error {
	if mock.err != nil {
		return mock.err
	}
	mock.orders = append(mock.orders, order)
	for _, customer := range mock.customers {
		if customer.ID == int(order.CustomerID) {
...
func (mock *MockDB) GetCreditCardCID(id int) (string, error) {
	if mock.err != nil {
		return "", mock.err
	}
	return "", nil
...
func (mock *MockDB) SaveCreditCardForCustomer(int, string) error {
	if mock.err != nil {
		return mock.err
	}
	return nil
