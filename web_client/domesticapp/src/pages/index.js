      ...
      <div>
        <header className="relative">
          <div className="container px-6 py-6 mx-auto lg:flex lg:items-center lg:justify-between">
            ...
            <div
              ...
              } absolute lg:static transition-all duration-300 w-full py-12 lg:py-0 left-1/2 lg:opacity-100 lg:translate-x-0 lg:bg-transparent lg:w-auto -translate-x-1/2 top-20 sm:top-24 bg-[#475F45]`}
            >
              <nav className="flex flex-col items-center space-y-8 lg:flex-row lg:space-y-0 lg:-mx-4">
                <a
                  href="#"
                  className="font-medium text-white lg:text-[#475F45] lg:hover:text-gray-400 lg:mx-4"
                >
                  Home
                </a>
                <a
        ...
        <section className="container flex flex-col items-center px-6 py-12 mx-auto lg:flex-row">
          <div className="lg:w-1/2">
            ...
            <div className="mt-6 sm:flex sm:items-center">
              <a
                href="#"
                className="bg-[#475F45] hover:bg-[#475F45]/80 duration-300 transition-colors border-2 border-[#475F45] px-6 block text-center py-3 uppercase text-sm font-bold leading-4 tracking-widest text-white "
              >
                Buy Tickets
              </a>
              <a
                href="#"
                className="border-2 text-sm duration-300 transition-colors hover:bg-[#475F45] hover:text-white font-bold leading-4 mt-4 sm:mt-0 tracking-widest text-[#475F45] sm:mx-4 border-[#475F45] px-6 block text-center py-3 uppercase"
              >
                Learn More
              </a>
            </div>
            ...
            <div className="order-2 mt-8 lg:order-1 lg:mt-0 lg:flex lg:items-center lg:-mx-6">
              ...
              <div className="mt-8 lg:w-1/2 lg:mx-6 lg:mt-0">
                ...
                <p className="mt-4 text-gray-200 ">
                  ...
                  Quibusdam, nisi fugiat dicta impedit sed quisquam quas
                  veritatis consectetur neque saepe, autem facilis dolore
                  officiis minima explicabo perferendis ab porro magnam!
                </p>
                <a
                  className="inline-flex px-6 py-3 mt-6 text-white border-2 border-white hover:bg-[#475F45] duration-300 transition-colors"
                  href="#"
                >
                  Learn More
                </a>
        ...
        <footer className="bg-[#414840]">
            ...
            <div>
              <a className="flex items-center -mx-2" href="#">
                ...
                <div className="mx-2 text-white">
                  <h3 className="font-medium tracking-widest uppercase">
                    Mist Gardens
                  </h3>
                  <p className="mt-1 text-xs italic leading-3 tracking-wide capitalize">
                    museum &amp; botanical garden
                  </p>
                </div>
              </a>
              <p className="max-w-lg mt-6 leading-relaxed text-white ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Incidunt voluptatum amet molestiae consequatur quam velit sint
                modi aut illo dolorem.
              </p>
            </div>
          ...
          <p className="w-full py-6 mx-auto text-white text-center bg-[#343D33]">
            © 2022 Mist Gardens. All rights reserved.
          </p>
        </footer>
      </div>
    </main>
